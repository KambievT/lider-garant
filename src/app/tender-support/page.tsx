      ...
      <FadeIn>
        <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-linear-to-br from-indigo-500/10 via-sky-500/10 to-emerald-500/10 p-8 md:p-12">
          ...
          <div className="relative grid items-center gap-8 md:grid-cols-2">
            ...
            <div className="hidden h-[320px] rounded-3xl border border-white/10 bg-white/5 p-6 text-sm text-foreground/70 backdrop-blur-xl md:flex md:flex-col md:justify-between"></div>
          </div>
        </section>
      </FadeIn>
      <FadeIn>
